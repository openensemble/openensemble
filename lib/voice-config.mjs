 ...
 */
export async function pushConfigToDevice(deviceId, ownerUserId, { fwVersion = null } = {}) {
  ...
  return { pushedSlots, ackedSlots, failedSlots, offlineSlots, clearedSlots, version: cfg.version };
}
