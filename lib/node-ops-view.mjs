...
function buildActionItems({ node, summaries, profiles, incidents }) {
  ...
  if (node.outdated && reachable) add('outdated', 'warn', `${node.hostname} agent is outdated`, `Current ${node.version || 'unknown'}, latest ${node.latestVersion || 'unknown'}.`, 'Upgrade agent', { nodeId: node.nodeId });
