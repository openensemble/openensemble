 ...
 * key (URL is fixed); piper needs the local service running.
 */
export async function getTtsAvailability(cfg) {
  const [ffmpeg, piper] = await Promise.all([
...
/** Force the next probe to re-run. Useful after install-piper SSE. */
