 ...
 * @param {{ userId?: string|null, agentId?: string|null, source?: string, rootId?: string|null, parentTurnId?: string|null, forceRoot?: boolean, turnId?: string|null, messageId?: string|null, attemptId?: string|null }} [opts]
 */
export function beginTurn({ userId, agentId, source = 'web', rootId = null, parentTurnId = null, forceRoot = false, turnId: requestedTurnId = null, messageId = null, attemptId = null } = {}) {
  try {
