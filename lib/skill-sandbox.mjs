 ...
 * @param {{ writableDirs?: string[], roDirs?: string[], roDirBinds?: Array<{source:string,target:string}>, roFileBinds?: Array<{source:string,target:string}>, cwd?: string|null, net?: boolean, env?: Record<string,string> }} [opts]
 */
export function buildSandboxArgs(bin, binArgs = [], opts = {}) {
  const {
    writableDirs = [], roDirs = [], roDirBinds = [], roFileBinds = [],
    cwd = null, net = true, env = {},
  } = opts;
  const args = [
 ...
 * @param {string} bin
 * @param {string[]} binArgs
 * @param {{ writableDirs?: string[], roDirs?: string[], roDirBinds?: Array<{source:string,target:string}>, roFileBinds?: Array<{source:string,target:string}>, cwd?: string|null, net?: boolean, env?: Record<string,string>, timeoutMs?: number, maxStdoutBytes?: number }} [opts]
 */
