 ...
 * @param {string} bin
 * @param {string[]} binArgs
 * @param {{ writableDirs?: string[], roDirs?: string[], roDirBinds?: Array<{source:string,target:string}>, roFileBinds?: Array<{source:string,target:string}>, cwd?: string|null, net?: boolean, env?: Record<string,string>, procMount?: boolean, timeoutMs?: number, maxStdoutBytes?: number }} [opts]
 */
