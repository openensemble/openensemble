...
// The generated filter payload is represented by `filters/build-info.json`
// rather than the rulesets themselves: it changes on every rebuild and is a
// few hundred bytes, where hashing the rulesets would read ~7MB per boot.
const _extSourceFiles = [
  'manifest.json',
  'background.js',
  'adblock-engine.js',
  'content-adblock.js',
