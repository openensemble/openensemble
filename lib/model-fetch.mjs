...
export const BUNDLED_PLAN_MODELS = {
  // DEPRECATED 2026-06-25: the `fast` tier (SmolLM2-135M, openensemble-plan-v5.q8_0.gguf)
  // was removed — it's too small to handle the local cognition/extract processing.
  // planFileForTier('fast') and any stale scheduler.builtinPlanModel pointing at the
  // 135M gguf now fall back to `accurate` (see resolvePlanModelFile).
