 ...
 */
export async function proposeMonitorableWatch({ userId, agentId, message, matched = null, evidenceCount = 2 }) {
  ...
  return createProposal({
    ...
    agentId,
    kind: 'watch',
    message: `You keep asking about a changing source. Set up a monitor for: ${message}`,
    matched,
    evidenceCount,
    accept_label: 'Set up the watch',
