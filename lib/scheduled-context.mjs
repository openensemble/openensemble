 ...
 * streamChat with a null systemNote — so sub-agents (e.g. the email specialist) don't know
...
export function getScheduledContext() {
  return scheduledContext.getStore() || null;
}

export function getScheduledNote() {
  return getScheduledContext()?.scheduledNote ?? null;
}
