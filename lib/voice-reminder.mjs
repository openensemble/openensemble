 ...
 * Synthesizes the announcement once, then pushes chime + TTS as one-shot
 * audio markers — firmware fetches each from /api/tts and queues for
 * playback. Skips offline devices silently (they can't fetch a marker).
 *
