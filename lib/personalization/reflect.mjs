...
export function buildUserPrompt({ existingMemories, observations, calendarEvents, sessionSummaries, now }) {
  ...
  if (observations.length) {
    for (const o of observations) lines.push(`- id=${o.id} [${o.ts}] (${o.source}${o.skillId ? '/' + o.skillId : ''}/${o.kind}${o.origin === 'automation' ? ', automated' : ''}) ${o.digest}`);
