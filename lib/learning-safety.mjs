...
export const DESTRUCTIVE_TOOL_RE =
  /(?:^|_)(?:delete|remove|cancel|destroy|drop|purge|trash|uninstall|kill|wipe|forget|clear|reset|terminate)(?:_|$)/i;

export const SENSITIVE_ARG_RE = /key|token|secret|password|auth|bearer/i;

export const INFRASTRUCTURE_DEFAULT_TOOL_RE =
  /^(?:coder_|skill_|node_exec$|ask_agent$|spawn_worker$|parallel_work$|claim_work$|check_workers$|stop_worker$|redirect_worker$|report_progress$|request_tools$|dispatch_op$|read_turns$|read_logs$|claim_role$|list_roles$)/i;
