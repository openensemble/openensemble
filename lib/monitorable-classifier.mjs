 ...
 *
 * Stateless by design — every turn re-classifies. If the user ignores
 * the offer once, the next time the same topic comes up we'll offer again.
 * No proposal queue, no flush logic.
 */
