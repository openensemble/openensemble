 ...
 * delegated-specialist calls. The LOCAL fastpath uses a different executor
 * (executeRoleTool), so a tool the local tier already handled is NOT recorded
 * here — meaning the recorder only ever holds "the LLM had to do it" executions,
 * which is exactly the miss signal the learner wants.
 *
