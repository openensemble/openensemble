 ...
 *
 * ctx: { userId, deviceId } — deviceId is the resolved target device (use
 *      resolveRoutineDeviceId at the call site). ambient + tts_say target it;
 *      ha_* actions are user-scoped (no device).
 */
