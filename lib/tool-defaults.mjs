...
import { isDefaultArgNoise, isDestructiveTool } from './learning-safety.mjs';
 ...
 */
export async function recordToolCall(userId, toolName, args, schemaDefaults = null) {
  ...
  for (const [argName, value] of Object.entries(args)) {
    ...
    if (!proposal && arr.length === minEvidence) {
      ...
      proposal = { proposed: true, tool: toolName, arg: argName, value, count: minEvidence };
    }
  }
