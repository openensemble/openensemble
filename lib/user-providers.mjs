 ...
 *
 * Sydney can add a new provider at runtime (via the oe-admin skill's
 * `add_provider` tool) without a code change. Each entry mirrors the
 * shape of OPENAI_COMPAT_PROVIDERS in chat/providers/_shared.mjs:
 *
