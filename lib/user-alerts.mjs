 ...
 *      the user finds it whenever they next open the conversation; and
 *   2. the channels they actually chose (`profile.reminderChannel`, the same
 *      preference the reminder path honors: websocket / telegram / email / all).
 *
 ...
 */
export async function alertUserOfFailure(userId, { title, detail, remedy, dedupKey, meta } = {}) {
