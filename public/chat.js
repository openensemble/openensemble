...
const TOOL_PLAN_CATALOG = [
  ...
  { name: 'ask_agent', label: 'Ask another agent', desc: 'Delegates work to another agent, usually in the background.', group: 'Agents', re: /\b(?:ask|delegate|have|tell)\b.{0,35}\b(?:agent|gina|sydney|coder|someone)\b/i },
