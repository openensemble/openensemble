...
- **Plan model** — a small bundled model that parses scheduling intent ("every Monday at 9am"). Two tiers ship: **fast** (`openensemble-plan-v5`, SmolLM2-135M, ~140 MB) and **accurate** (`openensemble-plan-360m-v1`, SmolLM2-360M, ~370 MB, default).
